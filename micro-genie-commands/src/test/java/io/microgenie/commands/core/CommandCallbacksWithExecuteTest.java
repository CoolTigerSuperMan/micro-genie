...
//		final TestCommand<String, String> commandWithException = new TestCommand<String, String>(MockCommands.REAL_VALUE, MockCommands.COMMAND_KEY, MockCommands.FALL_BACK_VALUE){
